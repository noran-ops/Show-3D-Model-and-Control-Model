...
class step extends StatelessWidget {
  ...
  //get onStepCount => null;

  //get onStepCountError => null;

  //get stepCountStream => null;
  double percent=0.1;
  ...
  //void setUpPedometer() {
     ...
     //_subscription = pedometer.stepCountValue.listen( _onData,
  ...
  //void setUpPedometer() {
    // Pedometer pedometer = new Pedometer();
     //dynamic pedometerStream;
   // _subscription = Pedometer.stepCountStream as StreamSubscription<int>;
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: AssetImage("images/icons/distance.png"),
                            fit: BoxFit.fitWidth,
                  ...
                  new Container(
                    child: new Card(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: AssetImage("images/icons/burned.png"),
                            fit: BoxFit.fitWidth,
                            alignment: Alignment.topCenter,
                          ),
                        ),
                  ...
                  new Container(
                    child: new Card(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: AssetImage("images/icons/walking.gif"),
                            fit: BoxFit.fitWidth,
                            alignment: Alignment.topCenter,
                          ),
                        ),
